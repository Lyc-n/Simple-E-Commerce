      ...
      <main className="flex-1 max-w-4xl w-full mx-auto p-6 md:py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-1 bg-surface-container-low border-2 border-[#333535] p-6 rounded-lg flex flex-col items-center text-center h-fit shadow-[6px_6px_0px_0px_#b20d0d]">
            <div className="relative w-24 h-24 mb-4 rounded-full border-4 border-[#ffe16d] overflow-hidden bg-[#282a2b] flex items-center justify-center">
          ...
          <div className="md:col-span-2 bg-surface-container-low border-2 border-[#333535] p-6 md:p-8 rounded-lg shadow-[6px_6px_0px_0px_#ffe16d]">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-1">
                <label className="block text-xs font-bold uppercase tracking-wider text-[#e5bdb8]">
                  Nomor Telepon <span className="text-xs text-secondary-fixed font-normal lowercase">(opsional)</span>
                </label>
                <input
                  type="text"
                  name="phone"
              ...
              <div className="space-y-1">
                <label className="block text-xs font-bold uppercase tracking-wider text-[#e5bdb8]">
                  Alamat Rumah <span className="text-xs text-secondary-fixed font-normal lowercase">(opsional)</span>
                </label>
                <textarea
                  name="address"
                  disabled={!isEditing}
              ...
              <div className="space-y-1">
                <label className="block text-xs font-bold uppercase tracking-wider text-[#e5bdb8]">
                  Bio <span className="text-xs text-secondary-fixed font-normal lowercase">(opsional)</span>
                </label>
                <input
                  type="text"
                  name="bio"
              ...
              <div className="pt-4">
                <button
                  type="submit"
                  className={`w-full py-4 text-xs tracking-[0.2em] font-black uppercase rounded transition-all active:scale-98 shadow-[4px_4px_0px_0px_#ffe16d] hover:-translate-y-0.5
                    ${isEditing 
                      ? 'bg-[#b20d0d] text-[#fff9ef] hover:bg-[#c91212]' 
                      : 'bg-[#282a2b] text-[#e2e2e2] hover:bg-[#37393a]'
                    }`}
                >
